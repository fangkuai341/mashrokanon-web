...
const I18N = {
  zh: {
    ...
    contact_title: "联系我",
    contact_desc: "森林的维护者就在这里 —— 投稿、勘误、合作或一句问候，都欢迎来信。",
    ct_qq: "QQ", ct_bili: "哔哩哔哩", ct_mail: "邮箱", ct_tg: "Telegram",
    contact_tip: "* 点击卡片即可跳转 / 发邮件，记得把示例账号替换成你的真实联系方式。",
  ...
  ja: {
    ...
    contact_desc: "森の管理人はここにいます。投稿・誤記修正・コラボ、ひと言のご挨拶でもお気軽にどうぞ。",
    ct_qq: "QQ", ct_bili: "ビリビリ", ct_mail: "メール", ct_tg: "Telegram",
    contact_tip: "* カードをクリックで各サービスへ遷移 / メール作成。サンプルIDは実際の連絡先に置き換えてください。",
